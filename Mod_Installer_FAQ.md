...
- Give exact details such as, was it isntalled on a new copy of the game?, which mods are also installed?, did you install mulitple mods with it and which ones?.
